    ...
    <div class="row">
        ...
        <div class="col-lg-11 col-md-11 col-sm-11">
            <form action="CUsuarios.do" method="POST" name="formUsuarios" id="fromUsuarios" autocomplete="off">
                ...
                <div class="panel panel-success" id="pnlDatosUsuario">
                ...
                <div id="divTipoPersona">
                    <div class="panel panel-success" id="pnlDatosPersona">
                        <div class="panel-heading">
                ...
                <div id="divTipoUnidad" style="display: none">
                    <div class="panel panel-success" id="pnlDatosUnidad">
                        <div class="panel-heading">
                            <h3 class="panel-title">Datos de Unidad Armada</h3>
                        </div>
                        <div class="panel-body">
                            <div class="col-lg-3 col-md-3 col-sm-3">
                                <div class="form-group">
