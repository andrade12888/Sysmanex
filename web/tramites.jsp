...
<div class="bodyContent">
    <form name="frmTramites" action="tramites.do" method="POST" id="formTramites">
        <div class="row">
            ...
            <div id="divTramitePlazo" class="col-lg-2"><span class="spanTramite">Plazo para tramitar</span><input id="txtPlazoTramite" required="required" type="number" name="txtPlazo" class="form-control" /></div>                                                     
            ...
            <div class="modal-body">
                <form name="frmActualizarTramite" id="frmActualizarTramite" action="tramites.do" method="POST">
                    ...
                    <div class="modal-footer">                    
                        ...
                        <button type="button" name="btnTramite" value="Update" class="btn-agregar" onclick="controlTextoVacio('frmActualizarTramite','txtActualizarTramite','txtActualizarPlazo','spanUpdTramite');">Guardar cambios</button>
