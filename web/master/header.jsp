<%-- 
    Document   : header
    Created on : 04-abr-2017, 22:33:40
    Author     : Nova
--%>
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                <li class="active"><a href="#">Bandeja de Entrada <span class="sr-only">(current)</span></a></li>
                ...
                <li><span class="navbar-text">Bienvenido! Usuario: <%= u1.getNombre()%>(<a href="logout.jsp">salir</a>)</span></li>
            </ul>
            <ul>
